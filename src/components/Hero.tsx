        ...
        <div className=" relative mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24">
          <>
            ...
            <div className="flex justify-center">
              <a
                className="inline-flex items-center gap-x-2 bg-white border border-gray-200 text-base text-gray-800 p-1 ps-3 rounded-full transition hover:border-gray-300 dark:bg-neutral-800 dark:border-neutral-700 dark:hover:border-neutral-600 dark:text-neutral-200"
                href="#"
              >
                Explore the World
          ...
          <div className="text-center">
            ...
            <div className="mt-5 max-w-3xl text-center mx-auto">
              <p className="text-primary-foreground">
                ...
                Make hotel reservations, find vacation packages, search cheap
                hotels and events
              </p>
            </div>
